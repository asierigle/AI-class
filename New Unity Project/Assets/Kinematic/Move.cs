...
public class Move : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (mov_velocity.magnitude > max_mov_velocity) 
		{
			...
			mov_velocity = mov_velocity * max_mov_velocity;
		}
		...
		degree = Mathf.Atan2(mov_velocity.x,mov_velocity.z)*Mathf.Rad2Deg;
		aim.transform.rotation = Quaternion.AngleAxis (degree, Vector3.up);
